...
#     """
#     Fungsi untuk memproses gambar dan mengenali rempah menggunakan model.
#     """
#     try:
#         # Simulasi hasil prediksi (ganti dengan model AI Anda)
#         recognized_rempah = "jahe"  # Contoh: hasil prediksi model
#         return recognized_rempah
#     except Exception as e:
#         print(f"Error processing image: {e}")
#         return None

# def get_rempah_info(name):
#     """
#     Mengambil informasi rempah dari dataset lokal atau database.
#     """
#     try:
#         with open('data/rempah_data.json') as f:
#             data = json.load(f)
#         return data.get(name)
#     except Exception as e:
#         print(f"Error fetching rempah info: {e}")
#         return None
